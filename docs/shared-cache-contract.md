...
공통 허구 quota fixture는 `shared/fixtures/snapshot.json`, JSONL 생성·양방향 검증은 `apps/node/tests/interop/sharedCacheInterop.test.ts`, Rust fixture 실행기는 `apps/rust/tools/cache_fixture.rs`에 있다.
